                  ...
                  <div class="overlay-box">
                    <div class="user-content">
                      <a href="javascript:void(0)">
                        <c:choose>
                            <c:when test="${accountAdmin==nul}">
                                <img src="${pageContext.request.contextPath}/view/admin/plugins/images/users/genu.jpg"
                                     class="thumb-lg img-circle" alt="img">
                            </c:when>
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}/images/${admin.image}"
                                     class="thumb-lg img-circle" alt="img">
                            </c:otherwise>
                        </c:choose>

                      </a>
                      <h4 class="text-white mt-2">${accountAdmin.getUsername()}</h4>
                  ...
                  <form action="profile" method="POST" class="form-horizontal form-material">
                    <div class="form-group mb-4">
                      ...
                      <div class="col-md-12 border-bottom p-0">
                        <input type="text" placeholder="Johnathan Doe" value="${admin.getFullname()}"
