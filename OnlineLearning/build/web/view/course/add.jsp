            ...
            <div class="page-wrapper">
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">Thêm khóa học mới</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../course/add">
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <input class="input--style-6" type="text" name="course_name" placeholder="Nhập tên của khóa học">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="course_overview" placeholder="Tổng quan của khóa học"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="course_description" placeholder="Chi tiết của khóa học"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="card-footer">
                                <button class="btn btn--radius-2 btn--blue-2" type="submit">Tạo khóa học</button>
                            </div>
                        </form>
                    </div>
