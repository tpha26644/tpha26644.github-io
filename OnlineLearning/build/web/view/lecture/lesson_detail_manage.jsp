            ...
            <div class="page-wrapper">
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <p style="color: white;"><span style="font-weight: bold;">Khóa học: </span> ${lesson.getChapter().getCourse().getCourseName()}</p>
                        <p style="color: white;"><span style="font-weight: bold;">Chương: </span> ${lesson.getChapter().getChapterName()}</p>
                        <h2 class="title">Bài giảng: ${lesson.getTitle()}</h2>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="name">Các bài kiểm tra</div>
                                <div class="value">
                                    <c:forEach items="${list_quiz}" var="q" varStatus="status">
                                        <div class="input-group">
                                            <a href="../lecture/quiz_detail?quizID=${q.getQuizID()}" style="text-decoration: none;">Quiz ${status.count}</a>
                                        </div>
                                    </c:forEach>
                                    <a href="../lecture/quiz_list?lessonID=${lesson.getLessonID()}">Tới giao diện quản lý các bài kiểm tra</a>
                                </div>
                            </div>
                        </form>
                    </div>
