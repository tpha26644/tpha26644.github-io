                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="overlay-box">
                                        <div class="user-content">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Ảnh của bạn</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-8 col-xlg-9 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="form-horizontal form-material" action="../lecture/edit_profile" method="POST">
                                        <input type="hidden" name="lectureID" value="${lecture.getLectureID()}" />
                                        <label for="exampleInputPassword1">Thêm ảnh mới </label><br>
                                        <div class="form-group mb-4">
                                            <input type="hidden" name="image" value="${lecture.getImage()}" />
                                            <input class="input-file" type="file" name="image_change" id="file">
                                        </div>
                                        <div class="form-group mb-4">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Họ và tên</label>
                                                <input type="text" name="fullname" class="form-control" id="exampleInputPassword1" value="${lecture.getFullname()}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="exampleInputPassword1">Email</label>
                                            <input type="text" name="email" class="form-control" id="exampleInputPassword1" value="${lecture.getEmail()}">

                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="exampleInputPassword1">Số điện thoại</label>
                                            <input type="text" name="phone" class="form-control" id="exampleInputPassword1" value="${lecture.getPhone()}">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="exampleInputPassword1">Ngày sinh</label>
                                            <input type="date" name="dob" class="form-control" id="exampleInputPassword1" value="${lecture.getDob()}">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="exampleInputPassword1">Địa chỉ</label>
                                            <input type="text" name="address" class="form-control" id="exampleInputPassword1" value="${lecture.getAddress()}">                                            
                                        </div>
                                        <div class="form-group mb-4">

                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="${lecture.isGender()}" ${lecture.isGender() == true ? "checked":""}>
                                            <label class="form-check-label" for="exampleRadios1">
                                                Nam
                                            </label>
                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="${lecture.isGender()}" ${lecture.isGender() == false ? "checked":""}>

                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="true" ${lecture.isGender() == true ? "checked":""}>
                                            <label class="form-check-label" for="exampleRadios1">
                                                Nam
                                            </label>
                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="false" ${lecture.isGender() == false ? "checked":""}>
