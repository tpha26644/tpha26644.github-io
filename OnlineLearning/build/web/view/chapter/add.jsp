            ...
            <div class="page-wrapper">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <div class="d-md-flex">
                                <ol class="breadcrumb ms-auto">
                                    <li><a href="home" class="fw-normal">Các chương của khóa học</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">Thêm chương mới cho khóa học "${course.getCourseName()}"</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../chapter/insert">
                            ...
                            <div class="card-footer">
                                <button class="btn btn--radius-2 btn--blue-2" type="submit">Tạo chương</button>
                            </div>
                        </form>
                    </div>
