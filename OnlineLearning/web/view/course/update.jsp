<%-- 
    ...
    Created on : Mar 3, 2022, 2:26:24 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <link href="css/course/add-course.css" rel="stylesheet" type="text/css"/>
        <%
            ArrayList<Category> list_category = (ArrayList<Category>) request.getAttribute("list_category");
        %>
    </head>
    <body>
        <div class="preloader">
            ...
            <div class="page-wrapper">
                <div class="page-breadcrumb bg-white">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Các khóa học</h4>
                        </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <div class="d-md-flex">
                                <ol class="breadcrumb ms-auto">
                                    <li><a href="lecture/course_list" class="fw-normal">Các khóa học</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">Chỉnh sửa khoá học</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="CourseUpdateController">
                            <div class="form-row">
                                <div class="name">Tên khóa học</div>
                                <div class="value">
                                    <input type="hidden" name="courseID" value="${c.getCourseID()}">
                                    <input class="input--style-6" type="text" name="course_name" value="${c.getCourseName()}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Tổng quan về khóa học</div>
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="course_overview" >${c.getOverview()}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Chi tiết về khóa học</div>
                                <div class="value">
                                    <div class="input-group">
                                        <textarea class="textarea--style-6" name="course_description">${c.getDescription()}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Ảnh của khóa học</div>
                                <div class="value">
                                    <div class="input-group js-input-file">
                                        <input class="input-file" type="file" name="image" id="file">
                                        <label class="label--file" for="file">Choose file</label>
                                        <span class="input-file__info">${c.getImage()}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="name">Khóa học thuộc danh mục</div>
                                <div class="value">
                                    <div class="input-group js-input-file">
                                        <select name="category">
                                            <%
                                                for (Category cate : list_category) {
                                            %>
                            ...
                            <div class="card-footer">
                                <input class="btn btn--radius-2 btn--blue-2" type="submit" name="submit" value="Lưu">
                            </div>
                        </form>
                    </div>
