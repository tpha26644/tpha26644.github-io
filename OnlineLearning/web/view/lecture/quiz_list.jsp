                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <c:forEach items="${list_quiz}" var="q" varStatus="status">
                                            <tr>
                                                ...
                                                <td><button class="btn d-grid btn-danger text-white"><a href="../lecture/delete_quiz?quizID=${q.getQuizID()}" style="text-decoration: none;color: white;">Delete</a></button></td>
                                            </tr>
                                        </c:forEach>
