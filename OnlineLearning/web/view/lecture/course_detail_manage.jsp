            ...
            <div class="page-wrapper">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <div class="d-md-flex">
                                <ol class="breadcrumb ms-auto">
                                    <li><a href="../lecture/listlearnerjoincourse?courseID=${course.getCourseID()}" class="fw-normal" style="color: blue">Danh sách học viên của khoá học</a></li>
                                </ol>
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">${course.getCourseName()}</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../course/add">
                            ...
                            <div class="form-row">
                                <div class="name">Các chương của khóa học</div>
                                <div class="value">
                                    <c:forEach items="${list_chapter}" var="c" varStatus="status">
                                        <p>Chương ${status.count}: <a href="../detail-chapter-lecture?chapterID=${c.getChapterID()}" style="text-decoration: none;
                                                                      color: black;">${c.getChapterName()}</a></p>
                                    </c:forEach>
                                    <a href="../list-chapter-lecture?courseID=${course.getCourseID()}">Tới giao diện quản lí chương</a>
                                </div>
