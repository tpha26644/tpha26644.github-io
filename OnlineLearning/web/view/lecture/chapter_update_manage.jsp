            ...
            <div class="page-wrapper">
                <div class="page-breadcrumb bg-white">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Các chương của khóa học</h4>
                        </div>
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">Sửa chương "${chapter.getChapterName()}" học của khóa "${course.getCourseName()}"</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="update-chapter-lecture?chapterID=${chapter.getChapterID()}">                            
                            <div class="form-row">
                                <div class="name">Tên chương</div>
                                <div class="value">
                                    <input class="input--style-6" type="text" name="chapter_name" placeholder="Nhập tên chương">
                                </div>
                                
                                <div class="name">Thuộc khóa học</div>
                                <div class="value">
                                    <select name="chapter_courseID">
                                        <c:forEach items="${listCourse}" var="lCourse" varStatus="track">
                                            <option value="${lCourse.getCourseID()}">${lCourse.getCourseName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>                                                                
                            </div>
