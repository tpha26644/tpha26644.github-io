            ...
            <div class="page-wrapper">
                <div class="page-breadcrumb bg-white">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Các bài giảng của chương</h4>
                        </div>
                ...
                <div class="card card-6">
                    <div class="card-heading" style="background-color: black;">
                        <h2 class="title">Sửa bài giảng "${lesson.getTitle()}" của chương "${chapter.getChapterName()}"</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="update-lesson-lecture?lessonID=${lesson.getLessonID()}">                            
                            <div class="form-row">
                                <div class="name">Tên bài giảng</div>
                                <div class="value">
                                    <input class="input--style-6" type="text" name="lesson_name" placeholder="Nhập tên bài giảng">
                                </div>

                                <div class="name">Reading URL</div>
                                <div class="value">
                                    <input class="input--style-6" type="text" name="lesson_reading" placeholder="Nhập link tới bài đọc">
                                </div>

                                <div class="name">Video URL</div>
                                <div class="value">
                                    <input class="input--style-6" type="text" name="lesson_video" placeholder="Nhập link tới video">
                                </div>

                                <div class="name">Thuộc chương</div>
                                <div class="value">
                                    <select name="lesson_chapterID">
                                        <c:forEach items="${listChapter}" var="lChapter" varStatus="track">
                                            <option value="${lChapter.getChapterID()}">${lChapter.getChapterName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button class="btn btn--radius-2 btn--blue-2" name="submit" type="submit">Sửa đổi</button>
                            </div>
                        </form>
                    </div>
